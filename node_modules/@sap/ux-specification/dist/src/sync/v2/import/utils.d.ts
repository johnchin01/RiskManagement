 ...
 */
export declare function findObjectPageV2(v2Pages: SapUiAppPagesV2, entitySet: string, pageKeys: string[]): SapUiAppPageV2 | undefined;
/**
 ...
 * @returns v2Page - page as specified in the manifest
 */
export declare function findListReportPageV2(v2Pages: SapUiAppPagesV2, pageKeys: string[]): SapUiAppPageV2 | undefined;
/**
 ...
 * For example - 'TableCustomColumns<dummyTarget><dummyTarget2>' is resolved as 'dummyTarget'.
