 ...
 */
function importActions(importParameters, config, factory, pageType, page) {
...
function addSettings(importParameters, config, factory, page, pageType) {
    ...
    importActions(importParameters, config, factory, pageType, page);
    //Filterbar:
    ...
    if (importParameters.jsonSchema['definitions']['LineItems']) {
        for (const columnKey in importParameters.jsonSchema['definitions']['LineItems'].properties) {
            ...
            if (!column.template) {
                ...
                utils_1.transferSettingsOfObject(config.table.columns[columnKey], importParameters.manifest, importParameters.jsonSchema['definitions'][schemaPropertyName], page.id, [columnKey]);
