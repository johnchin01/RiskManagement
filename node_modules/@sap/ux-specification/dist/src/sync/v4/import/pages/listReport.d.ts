 ...
 */
export declare function addSettings(importParameters: ImportListReportV4Parameters, config: ListReportConfig | AnalyticalListPageConfig, factory: MetadataInstanceInterface, page: SapUiAppPageV4, pageType: PageTypeV4): ListReportConfig | AnalyticalListPageConfig;
/**
 ...
 */
export declare function createListReportConfig(importParameters: ImportListReportV4Parameters): ListReportConfig | undefined;
